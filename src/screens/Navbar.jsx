...
const Navbar = () => {
  ...
  return (
    <nav className={`navbar ${theme === 'dark' ? 'bg-gray-800 text-white p-4 mb-6 flex justify-between' : 'bg-blue-800 text-black p-4 mb-6 flex justify-between'}`}>
      ...
      <div className="flex items-center space-x-2">
        ...
        <Link to='/about' className={`flex items-center border  rounded ${theme === 'dark' ? 'border-indigo-900 hover:bg-gray-700' : ' border-indigo-200 hover:bg-indigo-300'}`}>
