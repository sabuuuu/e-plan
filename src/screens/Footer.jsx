...
function Footer() {
  ...
  return (
<footer className={`body-font mt-auto ${theme === 'dark' ? 'text-gray-400 bg-gray-900' : 'text-gray-900'}`}>
    <div class="container px-3 py-4 mx-auto flex items-center sm:flex-row flex-col ">
      <a class="flex title-font font-medium items-center md:justify-start justify-center text-white">
        ...
        <span  className={`ml-3 text-sm font-bold font-body ${theme === 'dark' ? 'text-white' : 'text-gray-800'}`}>E-Plan for students</span>
      </a>
      <p class="text-sm text-gray-400 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-800 sm:py-2 sm:mt-0 mt-4 font-body">©2024 AIE —
        <a href="https://twitter.com/knyttneve" class="text-gray-500 ml-1" target="_blank" rel="noopener noreferrer">@G5</a>
      </p>
